...
public class LocalizationServiceImpl implements LocalizationService {
  ...
  public LocalizationDto createLocalization(LocalizationDto localizationDTO) {
    User user =
        userRepository
            .findById(localizationDTO.getUserId())
            .orElseThrow(
                () ->
                    new EntityNotFoundException(
                        "User not found for id:" + localizationDTO.getUserId()));
    Language language =
        languageRepository
            .findById(localizationDTO.getLanguageId())
            .orElseThrow(
                () ->
                    new EntityNotFoundException(
                        "Language not found for id:" + localizationDTO.getLanguageId()));
    Currency currency =
        currencyRepository
            .findById(localizationDTO.getCurrencyId())
            .orElseThrow(
                () ->
                    new EntityNotFoundException(
                        "Currency not found for id:" + localizationDTO.getCurrencyId()));
