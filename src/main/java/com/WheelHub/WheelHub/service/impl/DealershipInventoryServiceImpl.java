...
public class DealershipInventoryServiceImpl implements DealershipInventoryService {
    ...
    public DealershipInventoryDto createDealershipInventory(DealershipInventoryDto dealershipInventoryDTO) {
        ...
        Vehicle vehicle = vehicleRepository.findById(dealershipInventoryDTO.getVehicleId())
                .orElseThrow(() -> new EntityNotFoundException("Vehicle not found for id:" + dealershipInventoryDTO.getVehicleId()));

        DealershipInventory dealershipInventory = DealershipInventoryMapper.dtoToEntity(dealershipInventoryDTO);
    ...
    public void deleteDealershipInventory(Long id) {
        DealershipInventory dealershipInventory = dealershipInventoryRepository.findById(id)
                .orElseThrow(() -> new EntityNotFoundException("DealershipInventory not found for id:" + id));
