        ...
        VehicleCategory category =
                vehicleCategoryRepository
                        ...
                        .orElseThrow(
                                () ->
                                        new EntityNotFoundException(
                                                "vehicle category not found for id:"
                                                        + vehicleDTO.getVehicleCategoryId()));
        ...
        for (VehicleFeatureDto feature : vehicleDTO.getFeatures()) {
            VehicleFeature managedFeature =
                    vehicleFeatureRepository
                            ...
                            .orElseGet(
                                    () ->
                                            vehicleFeatureRepository.save(
                                                    VehicleFeatureMapper.dtoToEntity(feature)));
            managedFeatures.add(managedFeature);
        }
        vehicle.setFeatures(managedFeatures);

        Vehicle savedVehicle = vehicleRepository.save(vehicle);
        return VehicleMapper.entityToResponseDTO(savedVehicle);
    }
