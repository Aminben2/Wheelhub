...
public class AppointmentServiceImpl implements AppointmentService {
  ...
  public AppointmentDto createAppointment(AppointmentDto appointmentDTO) {
    User user =
        userRepository
            .findById(appointmentDTO.getUserId())
            .orElseThrow(
                () ->
                    new EntityNotFoundException(
                        "User not found for id:" + appointmentDTO.getUserId()));
    Vehicle vehicle =
        vehicleRepository
            .findById(appointmentDTO.getVehicleId())
            .orElseThrow(
                () ->
                    new EntityNotFoundException(
                        "Vehicle not found for id:" + appointmentDTO.getVehicleId()));
