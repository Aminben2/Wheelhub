...
public class ReviewController {
  ...
  @PreAuthorize("hasAuthority('reviews:read')")
  public ResponseEntity<HashMap<String, Double>> getRatingAvgForVehicle(
  ...
  public ResponseEntity<List<ReviewResponseDto>> getReviewsForVehicle(
      @PathVariable("id") @Min(1) Long id, @PathVariable("type") String type) {
  ...
  public ResponseEntity<ReviewResponseDto> updateReview(
      @PathVariable @Min(1) Long id, @Valid @RequestBody ReviewDto reviewDTO) {
