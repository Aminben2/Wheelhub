...
public class LocalizationController {
  ...
  public ResponseEntity<LocalizationDto> updateLocalization(
      @PathVariable @Min(1) Long id, @Valid @RequestBody LocalizationDto localizationDTO) {

    LocalizationDto updatedLocalization =
        localizationService.updateLocalization(id, localizationDTO);
