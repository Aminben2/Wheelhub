...
public class VehicleCategoryController {
  ...
  public ResponseEntity<VehicleCategoryResponseDto> createVehicleCategory(
      @Valid @RequestBody VehicleCategoryDto vehicleCategoryDto) {
    VehicleCategoryResponseDto createdVehicleCategory =
  ...
  public ResponseEntity<VehicleCategoryResponseDto> getVehicleCategoryById(
  ...
  public ResponseEntity<VehicleCategoryResponseDto> updateVehicleCategory(
      @PathVariable @Min(1) Long id, @Valid @RequestBody VehicleCategoryDto vehicleCategoryDto) {

    VehicleCategoryResponseDto updatedVehicleCategory =
        vehicleCategoryService.update(id, vehicleCategoryDto);
