...
public class PriceDropController {
  ...
  public ResponseEntity<PriceDropResponseDto> createPriceDrop(
      @Valid @RequestBody PriceDropDto priceDropDTO) {
  ...
  @PreAuthorize("hasAuthority('priceDrop:read')")
  public ResponseEntity<PriceDropResponseDto> getLatestPriceDropForVehicle(
  ...
  public ResponseEntity<PriceDropResponseDto> updatePriceDrop(
      @PathVariable @Min(1) Long id, @Valid @RequestBody PriceDropDto priceDropDTO) {
