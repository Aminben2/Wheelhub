...
public class VehicleImageController {
  ...
  public ResponseEntity<VehicleImageResponseDto> createVehicleImage(
      @Valid @RequestBody VehicleImageDto vehicleImageDTO) {

    VehicleImageResponseDto createdVehicleImage =
        vehicleImageService.createVehicleImage(vehicleImageDTO);
    return new ResponseEntity<>(createdVehicleImage, HttpStatus.CREATED);
  }

  @GetMapping("/{id}")
  @PreAuthorize("hasAuthority('vehicleImage:read')")
  public ResponseEntity<VehicleImageResponseDto> getVehicleImageById(
  ...
  @PreAuthorize("hasAuthority('vehicleImage:read')")
  public ResponseEntity<List<VehicleImageResponseDto>> getImagesForVehicle(
      @PathVariable @Min(1) Long id) {
  ...
  public ResponseEntity<VehicleImageResponseDto> updateVehicleImage(
      @PathVariable @Min(1) Long id, @Valid @RequestBody VehicleImageDto vehicleImageDTO) {

    VehicleImageResponseDto updatedVehicleImage =
        vehicleImageService.updateVehicleImage(id, vehicleImageDTO);
